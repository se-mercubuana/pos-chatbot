                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <label for="fname" class="col-sm-12 text-left control-label col-form-label">
                                    {{ $transaction->customer->name }} - {{ $transaction->customer->no_telp }}
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <label for="fname" class="col-sm-12 text-left control-label col-form-label">
                                    {{ \App\Utility\PosUtility::returnIndoDate($transaction->transfer_date, true)  }}
                                    <span style="font-size: 10px;">
                                        ({{ \Carbon\Carbon::createFromTimeStamp(strtotime($transaction->transfer_date))->diffForHumans() }}
                                        )
                                    </span>
                                </label>
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="fname" class="col-sm-5 text-right control-label col-form-label">
                                Tanggal Produk Dikirim
                            </label>
                            <div class="col-sm-7">
                                <label for="fname" class="col-sm-12 text-left control-label col-form-label">
                                    {{ \App\Utility\PosUtility::returnIndoDate($transaction->send_date, true)  }}
                                    <span style="font-size: 10px;">
                                        ({{ \Carbon\Carbon::createFromTimeStamp(strtotime($transaction->send_date))->diffForHumans() }}
                                        )
                                    </span>
                                </label>
                            </div>
