...
@section('mainContent')
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-6">
                <div class="card">
                    <form method="POST" class="form-horizontal" action="/transaction/pengiriman/{{$transaction->id}}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9 input-group">
                                    <input type="text" name="send_date" class="form-control" id="datepicker-autoclose"
                                           placeholder="">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="no_resi" class="form-control" id="fname"
