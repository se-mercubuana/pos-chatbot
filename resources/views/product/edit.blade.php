...
@section('mainContent')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <form method="POST" class="form-horizontal" action="/product/{{$product->id}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Modal" name="modal"
                                           ...
                                           value="{{\App\Utility\PosUtility::returnPrice($product->modal, true)}}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" placeholder="Harga Jual" name="price"
                                           onkeypress="return CheckNumeric();"
                                           value="{{\App\Utility\PosUtility::returnPrice($product->price, true)}}"
                                           onkeyup="FormatCurrency(this);" required>
                                </div>
                            </div>
